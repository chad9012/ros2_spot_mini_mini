...
from spot_mini_mini_pybullet.spotmicro import spot
import pybullet_utils.bullet_client as bullet_client
from gymnasium.envs.registration import register
from spot_mini_mini_pybullet.spotmicro.heightfield import HeightField
from spot_mini_mini_pybullet.spotmicro.OpenLoopSM.SpotOL import BezierStepper
import spot_mini_mini_pybullet.spotmicro.Kinematics.LieAlgebra as LA
from spot_mini_mini_pybullet.spotmicro.spot_env_randomizer import SpotEnvRandomizer
...
# Register as Gymnasium Environment
register(
    id="SpotMicroEnv-v0",
  ...
  """
    ...
    """
        ...
        if self.draw_foot_path:
            self.DrawFootPath()
        obs = np.array(self._get_observation())
    ...
    # Gymnasium compatibility: keep render/reset/seed/step methods usable
